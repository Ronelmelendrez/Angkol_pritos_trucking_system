    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="flex items-center gap-2">
          <label className="text-xs font-medium text-ink-soft whitespace-nowrap">From</label>
          <Input
            type="date"
            className="sm:w-40"
        ...
        <div className="flex items-center gap-2">
          <label className="text-xs font-medium text-ink-soft whitespace-nowrap">To</label>
          <Input
            type="date"
            className="sm:w-40"
